        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a
                  href={import.meta.env.DEV ? 'http://localhost:3002' : '/menhera'}
                  className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                >
                  맨헤라 분석기
                </a>
              ...
              <li>
                <a
                  href={import.meta.env.DEV ? 'http://localhost:3003' : '/mbti'}
                  className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                >
                  MBTI 대화 스타일
                </a>
          ...
          {/* Company Links */}
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900 dark:text-white">FunLab</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  to="/about"
          ...
          {/* Legal Links */}
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900 dark:text-white">정책</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  to="/privacy"
