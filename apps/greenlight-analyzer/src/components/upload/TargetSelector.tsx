...
import { ParsedChat } from '../../types/greenlight';
          ...
          {participants.map((participant) => {
            ...
            return (
              <motion.button
                ...
                className="w-full p-4 bg-gray-50 dark:bg-gray-700 rounded-xl text-left hover:bg-green-50 dark:hover:bg-green-900/20 hover:ring-2 hover:ring-green-500 transition-all"
