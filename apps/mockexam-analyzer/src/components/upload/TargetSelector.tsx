...
import { ParsedChat } from '../../types/mockexam';
        ...
        <div className="space-y-3">
          {participants.map((name) => (
            <motion.button
              ...
              className="w-full flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-pink-50 dark:hover:bg-pink-900/20 border-2 border-transparent hover:border-pink-300 dark:hover:border-pink-500 transition-all"
