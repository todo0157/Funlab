...
import { ParsedChat, AnalysisTier, TIER_INFO } from '../../types/mbti';
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="mt-6 w-full py-3 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-xl font-semibold text-center">
            무료로 시작하기
          </div>
        </motion.button>
        ...
        <motion.div
          whileHover={{ scale: 1.02 }}
          className="relative bg-gradient-to-br from-purple-500 to-indigo-500 rounded-2xl p-6 shadow-lg text-left"
        >
