...
import { ParsedChat, AnalysisTier, TIER_INFO } from '../../types/relationship';
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <motion.button
          ...
          disabled={isLoading}
          className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border-2 border-gray-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-500 transition-colors text-left disabled:opacity-50"
        >
          ...
          <div className="mt-6 w-full py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-xl font-semibold text-center">
            무료로 시작하기
          </div>
        </motion.button>
        ...
        <motion.div
          whileHover={{ scale: 1.02 }}
          className="relative bg-gradient-to-br from-teal-500 to-cyan-500 rounded-2xl p-6 shadow-lg text-left"
        >
          ...
          <button
            ...
            className="mt-6 w-full py-3 bg-white text-teal-600 rounded-xl font-semibold hover:bg-gray-100 transition-colors"
          >
