...
import { QuizData, QuizResult } from '../../types/bestfriend';
    ...
    <div className="w-full max-w-lg mx-auto">
      ...
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-1">
          <span className="text-violet-500">{quizData.targetName}</span> 찐친 테스트
        </h2>
        <p className="text-sm text-gray-500 dark:text-gray-400">
          {quizData.creatorName}님을 얼마나 알고 있나요?
        </p>
      </div>
              ...
              <motion.button
                ...
                className={`w-full p-4 rounded-xl text-left transition-all ${
                  selectedOption === index
                    ...
                    : 'bg-gray-50 dark:bg-gray-700 border-2 border-transparent hover:border-violet-300 dark:hover:border-violet-700'
                }`}
