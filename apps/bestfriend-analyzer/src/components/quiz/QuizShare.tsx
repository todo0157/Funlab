...
import { QuizData } from '../../types/bestfriend';
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg text-center">
        {/* Success icon */}
        <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-violet-500 to-indigo-500 rounded-full flex items-center justify-center">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-6">
          <span className="font-semibold text-violet-500">{quizData.targetName}</span> 테스트가 준비되었어요
        </p>
        ...
        <div className="space-y-3">
          <motion.button
            onClick={handleShare}
            className="w-full py-4 bg-gradient-to-r from-violet-500 to-indigo-500 text-white font-bold rounded-xl hover:from-violet-600 hover:to-indigo-600 transition-all shadow-lg flex items-center justify-center gap-2"
