...
import type { ParsedChat } from '../../types/character';
        ...
        <div className="space-y-3">
          {participants.map((name) => (
            <motion.button
              ...
              className="w-full flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 border-2 border-transparent hover:border-red-300 dark:hover:border-red-500 transition-all"
